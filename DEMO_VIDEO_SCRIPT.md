...
**Target Tracks:** *Ship It (1st Place) • Best UI (3rd Place) • Amazon Fast-Track Interview*  
...
| **4** | 1:35 – 2:10 | 35s | **4-in-1 Notice Studio & Guardrail** | Formal Letterhead mode, Before/After diff, Scenario 4 Section 69 limitation block. |
| **5** | 2:10 – 2:32 | 22s | **AWS Cloud Architecture & Scale** | Cloud Architecture modal (`Ctrl+K`), DynamoDB Single-Table JSON telemetry. |
...
### Scene 4: 4-in-1 Notice Studio & Deterministic Guardrails (1:35 – 2:10)
...
### Scene 5: AWS Cloud Architecture & Single-Table Telemetry (2:10 – 2:32)
...
**🎙️ Voiceover:**
> *"GrievEase AI is built cloud-native on AWS:
> - **HTTP API Gateway v2** with sub-50ms latency.
> - **DynamoDB Single-Table Design** handling cases, audit logs, and compliance rules.
> - **Amazon EventBridge & SES** for automated limitation deadline alerts.
> - Deployed live on **AWS Amplify Hosting**."*
...
> 🖥️ **Screen Action:**
> - Return to main Dashboard view showing the live Amplify URL.
> - Display closing end card: *GrievEase AI — Democratizing Statutory Justice for 1.4 Billion Citizens on AWS*.

**🎙️ Voiceover:**
> *"By combining AWS Step Functions, Amazon Bedrock Knowledge Bases, and deterministic guardrails, GrievEase AI turns a grueling legal process into a 45-second autonomous resolution.
> 
